...
let tipValue = 0.15; // default value -> 15% btn is default active
let peopleValue = 1;
...
function handleClick(event) {
    ...
    //clear custom tip when clicking on other tip values
    tipCustom.value = '';
...
function setPeopleValue() {
    if(!validateInt(people.value)) {
        people.value = people.value.substring(0, people.value.length-1);   //just like th eothers, makes sure you can only input an integer
    }
